...
public:
	...
	bool Create(UINT bindFlags, UINT bufferSize, D3D11_USAGE bufferUsage, UINT structureByteStride, const D3D11_SUBRESOURCE_DATA* initData);
...
public:
	...
	// アンオーダードアクセスビュー取得
	ID3D11UnorderedAccessView* GetUAView() const { return m_uav; }
	// アンオーダードアクセスビューのアドレス取得
	ID3D11UnorderedAccessView* const* GetUAViewAddress() const { return &m_uav; }
